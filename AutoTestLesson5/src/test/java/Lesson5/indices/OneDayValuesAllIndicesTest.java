...
import Lesson5.Indices.oneDay.OneDay;
...
public class OneDayValuesAllIndicesTest extends AbstractTest {

    private static final Logger logger
            = LoggerFactory.getLogger(OneDayValuesAllIndicesTest.class);

    @Test
    void getOneDayValuesAllIndices_shouldReturn200() throws IOException {
        logger.info("Тест код ответ 200 запущен");
        ObjectMapper mapper = new ObjectMapper();
        OneDay oneDay = new OneDay();
        oneDay.setName("Flight Delays");
    ...
    @Test
    void getOneDayValuesAllIndices_shouldReturn401() throws IOException, URISyntaxException {
